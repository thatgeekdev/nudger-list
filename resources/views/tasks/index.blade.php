...
<div>
    <a href="{{ route('tasks.filter', 'pending') }}">Pending</a>
    <a href="{{ route('tasks.filter', 'in_progress') }}">In Progress</a>
    <a href="{{ route('tasks.filter', 'completed') }}">Completed</a>
</div>

<a href="{{ route('tasks.create') }}">Create New Task</a> |
<a href="{{ route('tasks.trashed') }}">View Trashed Tasks</a>
                ...
                <ul aria-label="top bar right" aria-orientation="horizontal" class="px-8 flex items-center">
                    <li class="relative">
                        ...
                        <i class="pointer-events-none absolute top-0 right-0 h-full flex items-center pr-3">
                            <svg class="fill-current w-4 h-4 mx-auto" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24">
                                <path
                    ...
                    <li class="h-8 w-8 ml-3">
                        <button title="Products" aria-label="chi desk products"
                            ...
                            <i class="text-gray-600">
                                <svg class="fill-current w-5 h-5 mx-auto" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24">
                                    <path
                                        ...
                                        <span
                                            ...
                                            <article>
                                                <header>
                                                    <div>
                                                        <span
                                                            class="px-3 py-1 uppercase text-xs leading-none rounded-sm bg-yellow-400 text-black">New</span>
                                                        <span class="ml-2 text-gray-700">Incident #12534</span>
                                                        <span class="ml-1">(Low)</span>
                                                    </div>
                                                </header>
